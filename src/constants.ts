...
export const EXPERIENCES: Experience[] = [
  {
    ...
    responsibilities: [
      "Leading high-impact AI backend projects",
      "Designing and improving scalable distributed systems performance and reliability",
      // "Improving system performance and reliability",
      "Taking ownership of complex engineering problems and delivering solutions",
  ...
  },
  {
    ...
    location: "Gurgaon",
    responsibilities: [
      "Developed backend system across Payments, Listings, and Core platforms",
      "Built microservices using Java and Spring Boot handling high-throughput traffic",
      "Designed and optimized REST APIs for performance and system reliability by reducing latency through performance tuning",
      "Worked on multiple databases including MongoDB, MySQL, Redis, Elasticsearch, and Kafka for data storage and real-time processing",
    ],
  },
  {
