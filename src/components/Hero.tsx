        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-6">
              Hi, I'm <span className="text-indigo-500">{PERSON_DETAILS.name.split(' ')[0]}</span>
              <br />
              <span className="text-gray-400">{PERSON_DETAILS.role}</span>
            </h1>
            
            <div className="h-12 flex items-center mb-8">
              <span className="text-xl md:text-2xl text-gray-300 mr-3">Expert in</span>
              <motion.span
                key={skillIndex}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-8 bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl">
                ...
                <div className="mt-6 pt-6 border-t border-white/10">
                  <div className="text-2xl font-bold text-indigo-400 mb-1">1300+</div>
                  <div className="text-xs text-gray-500 uppercase tracking-widest">LeetCode Solved</div>
                </div>
              </div>
            </div>
          </motion.div>
